...
直接の委託先だけをマスタに載せても、再委託先が見えないと、業者集中も地域の偏りも分析できません。再委託先（Nth Party）の持ち方は[再委託先管理の機能](/service/#nth-party)を見てください。定義・承諾・禁止の本編は、別途noteで記事にし、具体的な機能のご説明もしたいと思います。このページでは、直接の相手を案件とマスタに載せるところまでのご紹介とします。
